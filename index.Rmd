...
These table show the trash and debris collected at a site for a given date.  The first table shows counts by category using the [ETAP method]((https://www.epa.gov/system/files/documents/2021-09/revised_final_etap_june2021.pdf){target="_blank"}) and the second tables shows the weights by category.  Litter includes those items that can be assigned to a category using the ETAP method and debris defines those items without a category (usually large, specific items).
